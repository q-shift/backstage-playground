...
**NOTE**: As the tokens, password, tokens, etc to be defined should map the variables defined within the `manifest/helm/templates/app-config.qshift.yaml`, please review the configMap file first !
