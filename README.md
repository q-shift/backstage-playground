...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|
| [Core - 1.21](https://github.com/backstage/versions/blob/main/v1/releases/1.21.0/manifest.json)                                                                                                                                                           | GitHub                                           |
...
| [Quarkus Console](https://github.com/q-shift/backstage-plugins?tab=readme-ov-file#quarkus-console)                                                                                                                                                        | Red Hat OpenShift 4.14                           |
